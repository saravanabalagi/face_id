...
mkdir('data/face_recognition/images/data');

for i =1:length(tr_img_sample)
    imwrite(tr_img_sample{i,1}, ['data/face_recognition/images/data/', tr_img_sample{i,2}, '.png']);
...
mkdir('data/face_recognition/images/test');

for i =1:length(va_img_sample)
    imwrite(va_img_sample{i,1}, ['data/face_recognition/images/test/', va_img_sample{i,2}, '.png']);
...
datapath = 'data/face_recognition/images/data/';
testpath = 'data/face_recognition/images/test/';
...
TestImage = strcat(testpath,char(TestImage));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
